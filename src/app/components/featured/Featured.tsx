    ...
    return (
        <div className="mt-10">
            <h1 className="mb-4 font-serif">
                <span className="font-bold text-6xl">Les Illuminés de Bruxelles </span> 
                <span className="text-6xl"> seraient en guet-à-pinte depuis 1830!</span>
            </h1>
            <div className="flex gap-8">
                ...
                <div className="flex-1 pt-12">
                    <h2 className="font-mono mb-4">
                        <span className="text-4xl font-bold">Rumeurs ou vérité ? </span>
                        <span className="text-3xl">Père la Conspi vous dis tout...</span>
                    </h2>
